...
## Overview
This FFS Web Tool was designed to be a user- friendly tool for the “non-bioinformaticians” to do preliminary analyses of FFS Assay data. The most up-to-date version of the tool can be accessed here: 
...
**Step 1.** Select the correct entry page according to your dataset:
...
**Step 2.** 
Upload file from Step 1, use the available tools to filter the samples (rows) and assay data (columns) and proceed to Step3
...
<center>![Step 3 Plotting](./step3_5.jpg){width=70%}</center>
<br>
